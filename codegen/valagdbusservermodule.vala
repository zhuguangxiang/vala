...
public class Vala.GDBusServerModule : GDBusClientModule {
	...
	void generate_property_notify (ObjectTypeSymbol sym, Property prop) {
		...
		ccode.add_declaration ("GError*", new CCodeVariableDeclarator.zero ("error", new CCodeConstant ("NULL")));
		ccode.add_declaration ("GValue", new CCodeVariableDeclarator.zero ("value", new CCodeConstant ("G_VALUE_INIT")));
...
*/
		...
		var object_get_property = new CCodeFunctionCall (new CCodeIdentifier ("g_object_get_property"));
		object_get_property.add_argument (new CCodeIdentifier ("gobject"));
		object_get_property.add_argument (new CCodeConstant.string ("\"%s\"".printf (get_ccode_name (prop))));
		object_get_property.add_argument (new CCodeUnaryExpression (CCodeUnaryOperator.ADDRESS_OF, new CCodeIdentifier ("value")));
		...
		dbus_gvalue_to_gvariant.add_argument (new CCodeUnaryExpression (CCodeUnaryOperator.ADDRESS_OF, new CCodeIdentifier ("value")));
